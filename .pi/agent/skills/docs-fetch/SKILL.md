...
name: docs-fetch
description: >-
  Retrieves up-to-date library docs and API references online. Prefer this skill over web search when you need documentation of a specific framework, a tool, external package or APIs.
---
