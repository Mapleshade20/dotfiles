...
name: context7
description: >-
  Retrieves up-to-date library documentation and API references. Prefer this over web search when you encounter issues about a framework, external package or other APIs. If you're not Librarian, delegate use of this to @librarian agent.
---
...
Make sure the CLI is present. If not, abort and ask your dispatcher to run `npm install -g ctx7@latest`
